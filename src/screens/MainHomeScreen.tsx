...
const styles = StyleSheet.create({
  ...
  scrollContentContainer: {
    paddingTop: verticalScale(60), // Add padding to account for absolute positioned header (HEADER_HEIGHT)
    paddingBottom: verticalScale(80), // Padding for FAB
  },
  taskListContainer: {
  ...
  headerText: {
    ...
    letterSpacing: 1,
    textShadowRadius: 10,
    // Add a subtle background to ensure text visibility
  ...
  heatmapGrid: {
    ...
    flexWrap: 'wrap',
    justifyContent: 'space-between',
    marginTop: verticalScale(5), // Add a small top margin
  },
  heatmapDateCell: {
    ...
    justifyContent: 'center',
    alignItems: 'center',
    marginVertical: scale(1), // Reduce margin to prevent cropping
    borderRadius: moderateScale(8),
  ...
  heatmapDateDefault: {
    backgroundColor: colors.surface, // Light grey for unmarked days
  },
  heatmapDateFuture: {
  ...
  pickerModalContent: {
    backgroundColor: 'rgba(255, 255, 255, 0.95)', // Glass background
    borderRadius: moderateScale(20),
    width: '90%',
    maxWidth: 400,
    padding: scale(20),
